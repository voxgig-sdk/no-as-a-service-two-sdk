...
Learn more about No-as-a-Service API at [github.com/hotheadhacker/no-as-a-service](https://github.com/hotheadhacker/no-as-a-service).
...
This SDK exposes the API as a small set of **semantic entities** — RejectionReason — that you
...
| --- | --- | --- |
| **RejectionReason** | The RejectionReason entity (load). | `/no` |
