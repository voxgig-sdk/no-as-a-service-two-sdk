...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.NOASASERVICETWO_TEST_LIVE ||
    'TRUE' === process.env.NOASASERVICETWO_TEST_OVERRIDE
  ) {
  ...
  m.NOASASERVICETWO_TEST_EXPLAIN = process.env.NOASASERVICETWO_TEST_EXPLAIN || m.NOASASERVICETWO_TEST_EXPLAIN
