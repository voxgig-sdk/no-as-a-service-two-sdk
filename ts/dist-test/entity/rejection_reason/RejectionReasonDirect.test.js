...
(0, node_test_1.describe)('RejectionReasonDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.NoAsAServiceTwoSDK({
    ...
    (0, node_test_1.test)('direct-load-rejection_reason', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rejection_reason', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.NO_AS_A_SERVICE_TWO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.NoAsAServiceTwoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['NO_AS_A_SERVICE_TWO_TEST_REJECTION_REASON_ENTID'];
    ...
    const client = new __1.NoAsAServiceTwoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=RejectionReasonDirect.test.js.map