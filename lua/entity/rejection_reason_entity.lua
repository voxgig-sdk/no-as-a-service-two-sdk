...
local RejectionReasonEntity = {}
RejectionReasonEntity.__index = RejectionReasonEntity


function RejectionReasonEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, RejectionReasonEntity)
  self._name = "rejection_reason"
  self._client = client
...
function RejectionReasonEntity:get_name()
  return self._name
end


function RejectionReasonEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RejectionReasonEntity.new(self._client, opts)
end
...
function RejectionReasonEntity:mark_deleted()
  self._deleted = true
end


function RejectionReasonEntity:deleted()
  return true == self._deleted
end


function RejectionReasonEntity:data_set(args)
  if args ~= nil then
...
function RejectionReasonEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RejectionReasonEntity:match_set(args)
  if args ~= nil then
...
function RejectionReasonEntity:match_get()
...
function RejectionReasonEntity:stream(action, args, callopts)
...
function RejectionReasonEntity:_run_op(ctx, post_done)
  local utility = self._utility
