...
describe("RejectionReasonDirect", function()
  it("should direct-load-rejection_reason", function()
    local setup = rejection_reason_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rejection_reason", setup.live and "live" or "unit")
