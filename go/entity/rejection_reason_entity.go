...
type RejectionReasonEntity struct {
	name    string
	client  *core.NoAsAServiceTwoSDK
...
func NewRejectionReasonEntity(client *core.NoAsAServiceTwoSDK, entopts map[string]any) *RejectionReasonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RejectionReasonEntity) GetName() string { return e.name }
...
func (e *RejectionReasonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RejectionReasonEntity) Deleted() bool {
	return e.deleted
}


func (e *RejectionReasonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRejectionReasonEntity(e.client, opts)
}

func (e *RejectionReasonEntity) Data(args ...any) any {
...
func (e *RejectionReasonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an RejectionReason; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RejectionReasonEntity) DataTyped(data ...RejectionReason) RejectionReason {
	if len(data) > 0 {
		return typedFrom[RejectionReason](e.Data(asMap(data[0])))
	}
	return typedFrom[RejectionReason](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through RejectionReason (all fields
// optional at the wire level).
func (e *RejectionReasonEntity) MatchTyped(match ...RejectionReason) RejectionReason {
	if len(match) > 0 {
		return typedFrom[RejectionReason](e.Match(asMap(match[0])))
	}
	return typedFrom[RejectionReason](e.Match())
}
...
func (e *RejectionReasonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RejectionReasonEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RejectionReasonLoadMatch and returns an RejectionReason. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RejectionReasonEntity) LoadTyped(reqmatch RejectionReasonLoadMatch, ctrl map[string]any) (RejectionReason, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return RejectionReason{}, err
	}
	return typedFrom[RejectionReason](res), nil
}



func (e *RejectionReasonEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *RejectionReasonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RejectionReasonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RejectionReasonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RejectionReasonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
