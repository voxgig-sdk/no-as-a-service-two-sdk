...
type NoAsAServiceTwoSDK struct {
	Mode     string
...
func (sdk *NoAsAServiceTwoSDK) OptionsMap() map[string]any {
...
func (sdk *NoAsAServiceTwoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *NoAsAServiceTwoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *NoAsAServiceTwoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NoAsAServiceTwoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *NoAsAServiceTwoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *NoAsAServiceTwoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("NoAsAServiceTwoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *NoAsAServiceTwoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *NoAsAServiceTwoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("NoAsAServiceTwoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *NoAsAServiceTwoSDK {
	...
	sdk := NewNoAsAServiceTwoSDK(sdkopts)
	sdk.Mode = "test"
