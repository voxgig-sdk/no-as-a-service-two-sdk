...
from noasaservicetwo_sdk.noasaservicetwo_types import (
    RejectionReason,
...
class RejectionReasonEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return RejectionReasonEntity(self._client, opts)
    ...
    def data_get(self) -> RejectionReason:
    ...
    def match_get(self) -> RejectionReason:
