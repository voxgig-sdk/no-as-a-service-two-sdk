...
from noasaservicetwo_sdk.utility import register

# Load features
from noasaservicetwo_sdk.feature.base_feature import NoAsAServiceTwoBaseFeature
from noasaservicetwo_sdk.features import _has_feature, _make_feature
...
class NoAsAServiceTwoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = NoAsAServiceTwoUtility()
        self._utility = utility

        from noasaservicetwo_sdk.config import shared_config
    ...
    def get_utility(self):
        return NoAsAServiceTwoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NoAsAServiceTwoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def RejectionReason(self, data=None) -> "RejectionReasonEntity":
        ...
        from noasaservicetwo_sdk.entity.rejection_reason_entity import RejectionReasonEntity
