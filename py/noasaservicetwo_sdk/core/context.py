...
from noasaservicetwo_sdk.core.helpers import get_ctx_prop, to_map
...
class NoAsAServiceTwoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = NoAsAServiceTwoControl()
        ...
        if isinstance(sp, NoAsAServiceTwoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, NoAsAServiceTwoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, NoAsAServiceTwoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return NoAsAServiceTwoOperation({})
    ...
    def make_error(self, code, msg):
        return NoAsAServiceTwoError(code, msg, self)
