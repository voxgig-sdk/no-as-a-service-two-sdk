# NoAsAServiceTwo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NoAsAServiceTwoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NoAsAServiceTwoSDK(...) and NoAsAServiceTwoSDK.test(...) become
#      NoAsAServiceTwoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "noasaservicetwo_sdk"
_SDK_CLASS = "NoAsAServiceTwoSDK"
