...
// NoAsAServiceTwo SDK clienttrack feature
...
class NoAsAServiceTwoClienttrackFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    public function PostConstruct(NoAsAServiceTwoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'NoAsAServiceTwo-SDK';
