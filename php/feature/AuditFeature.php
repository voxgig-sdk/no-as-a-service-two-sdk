...
// NoAsAServiceTwo SDK audit feature
...
class NoAsAServiceTwoAuditFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _emit(NoAsAServiceTwoContext $ctx, string $outcome): void
    {
