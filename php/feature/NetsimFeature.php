...
// NoAsAServiceTwo SDK netsim feature
...
class NoAsAServiceTwoNetsimFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _simulate(NoAsAServiceTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NoAsAServiceTwoContext $ctx, array $applied): void
    {
        $client = $this->client;
