...
// NoAsAServiceTwo SDK debug feature
...
class NoAsAServiceTwoDebugFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _finish(NoAsAServiceTwoContext $ctx, bool $ok): void
    {
