...
// NoAsAServiceTwo SDK ratelimit feature
...
class NoAsAServiceTwoRatelimitFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _acquire(NoAsAServiceTwoContext $ctx): void
    {
    ...
    private function _track(NoAsAServiceTwoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
