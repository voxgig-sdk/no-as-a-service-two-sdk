...
// NoAsAServiceTwo SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class NoAsAServiceTwoTransformResponse
{
    public static function call(NoAsAServiceTwoContext $ctx): mixed
    {
        ...
        $transform = NoAsAServiceTwoHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
