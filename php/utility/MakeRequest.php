...
// NoAsAServiceTwo SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class NoAsAServiceTwoMakeRequest
{
    public static function call(NoAsAServiceTwoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new NoAsAServiceTwoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new NoAsAServiceTwoResponse($fetched);
        } else {
