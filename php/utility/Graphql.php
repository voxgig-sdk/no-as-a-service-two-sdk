...
// NoAsAServiceTwo SDK utility: graphql
//
...
class NoAsAServiceTwoGraphql
{
    ...
    // equivalent.
    public static function body(NoAsAServiceTwoContext $ctx): mixed
    {
    ...
    public static function errors(NoAsAServiceTwoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
