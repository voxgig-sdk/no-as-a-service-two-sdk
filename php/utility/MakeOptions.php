...
// NoAsAServiceTwo SDK utility: make_options

class NoAsAServiceTwoMakeOptions
{
    ...
    public static function call(NoAsAServiceTwoContext $ctx): array
    {
        ...
        //
        // `NoAsAServiceTwoSchema::optspec()` is built from the model:
        ...
        $optspec = NoAsAServiceTwoSchema::optspec();
