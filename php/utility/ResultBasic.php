...
// NoAsAServiceTwo SDK utility: result_basic

class NoAsAServiceTwoResultBasic
{
    public static function call(NoAsAServiceTwoContext $ctx): ?NoAsAServiceTwoResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof NoAsAServiceTwoError) ? $result->err->msg : (string)$result->err;
