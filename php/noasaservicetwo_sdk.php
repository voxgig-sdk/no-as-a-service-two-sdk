...
class NoAsAServiceTwoSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $utility = new NoAsAServiceTwoUtility();
        ...
        $feature_opts = NoAsAServiceTwoHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = NoAsAServiceTwoHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!NoAsAServiceTwoFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, NoAsAServiceTwoFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return NoAsAServiceTwoUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = NoAsAServiceTwoHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = NoAsAServiceTwoHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = NoAsAServiceTwoHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new NoAsAServiceTwoError($op . "_allow",
                "NoAsAServiceTwoSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = NoAsAServiceTwoHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new NoAsAServiceTwoError("graphql_error",
                "NoAsAServiceTwoSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function RejectionReason($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_rejection_reason === null) {
                $this->_rejection_reason = new RejectionReasonEntity($this, null);
            }
            return $this->_rejection_reason;
        }
        return new RejectionReasonEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new NoAsAServiceTwoSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
