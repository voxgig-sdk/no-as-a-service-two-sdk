# NoAsAServiceTwo PHP SDK Reference

Complete API reference for the NoAsAServiceTwo PHP SDK.
...
#### `NoAsAServiceTwoSDK::test($testopts = null, $sdkopts = null)`
