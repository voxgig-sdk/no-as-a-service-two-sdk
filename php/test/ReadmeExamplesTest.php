...
// NoAsAServiceTwo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NoAsAServiceTwoSDK::test)
...
{
    private const SDK_CLASS = 'NoAsAServiceTwoSDK';
    ...
    private const SDK_BASE = 'noasaservicetwo_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../noasaservicetwo_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
