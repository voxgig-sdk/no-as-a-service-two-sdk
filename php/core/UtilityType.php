...
// NoAsAServiceTwo SDK utility type

class NoAsAServiceTwoUtility
{
    ...
    public static function copy(NoAsAServiceTwoUtility $src): NoAsAServiceTwoUtility
    {
        $u = new NoAsAServiceTwoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
