// Command NoAsAServiceTwo-mcp is an MCP server exposing the NoAsAServiceTwo
// SDK as MCP tools.
//
// Two tools are registered:
//
//	NoAsAServiceTwo_list  — list records of an entity
//	NoAsAServiceTwo_load  — load a single record of an entity
//
