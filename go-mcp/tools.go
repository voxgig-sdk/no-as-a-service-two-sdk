...
type Args struct {
	Entity string         `json:"entity" jsonschema:"rejection_reason"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.NoAsAServiceTwoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "no-as-a-service-two_list",
		Description: "List records from NoAsAServiceTwo. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "no-as-a-service-two_load",
		Description: "Load a single record from NoAsAServiceTwo. " +
...
func runOp(client *sdk.NoAsAServiceTwoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NoAsAServiceTwoSDK, name string) (sdk.NoAsAServiceTwoEntity, error) {
	switch strings.ToLower(name) {
	case "rejection_reason":
		return client.RejectionReason(nil), nil
