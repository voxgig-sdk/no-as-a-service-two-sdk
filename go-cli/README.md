...
AQL-driven CLI and REPL for the NoAsAServiceTwo SDK. Positional arguments are
...
```sh
go build -o no-as-a-service-two-cli ./...
```
...
./no-as-a-service-two-cli list rejection_reason
./no-as-a-service-two-cli load 1 rejection_reason
./no-as-a-service-two-cli load '{id:1}' rejection_reason
