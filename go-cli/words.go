...
func registerSDKWords(r *eng.Registry, client *sdk.NoAsAServiceTwoSDK) {
...
func runOp(client *sdk.NoAsAServiceTwoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
