...
|---|---|---|
| `ts/` | @voxgig-sdk/no-as-a-service-two-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/no-as-a-service-two-sdk \
      --repository voxgig-sdk/no-as-a-service-two-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/no-as-a-service-two-sdk` shows it, and
`npm trust revoke @voxgig-sdk/no-as-a-service-two-sdk --id=<id>` removes it.
