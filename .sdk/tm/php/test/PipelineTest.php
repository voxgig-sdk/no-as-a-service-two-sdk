...
// NoAsAServiceTwo SDK pipeline test
//
...
{
    private static function utility(): NoAsAServiceTwoUtility
    {
        return new NoAsAServiceTwoUtility();
    }
    ...
    private static function ctx(array $over = []): NoAsAServiceTwoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NoAsAServiceTwoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NoAsAServiceTwoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NoAsAServiceTwoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NoAsAServiceTwoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NoAsAServiceTwoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NoAsAServiceTwoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NoAsAServiceTwoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NoAsAServiceTwoResponse([]),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        [, $err] = NoAsAServiceTwoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec([]),
            'response' => null,
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        [, $err] = NoAsAServiceTwoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec(['step' => 's']),
            'response' => new NoAsAServiceTwoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        [, $err] = NoAsAServiceTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec(['step' => 's']),
            'response' => new NoAsAServiceTwoResponse(self::resp(200, ['v' => 1])),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        [, $err] = NoAsAServiceTwoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec(['step' => 's']),
            'response' => new NoAsAServiceTwoResponse(self::resp(200, ['v' => 2])),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceTwoMakeResponse::call($ctx);
    ...
    {
        $preset = new NoAsAServiceTwoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec([]),
            'response' => new NoAsAServiceTwoResponse([]),
            'result' => new NoAsAServiceTwoResult([]),
        ...
        [$got, $err] = NoAsAServiceTwoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NoAsAServiceTwoResult([])]);
        [, $err] = NoAsAServiceTwoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NoAsAServiceTwoSpec([]), 'result' => null]);
        [, $err] = NoAsAServiceTwoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NoAsAServiceTwoSpec(['step' => 's']),
            'result' => new NoAsAServiceTwoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NoAsAServiceTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NoAsAServiceTwoSpec(['step' => 's']),
            'result' => new NoAsAServiceTwoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NoAsAServiceTwoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NoAsAServiceTwoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NoAsAServiceTwoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NoAsAServiceTwoSpec([]),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NoAsAServiceTwoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NoAsAServiceTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NoAsAServiceTwoError('boom', 'boom');
        $utility->fetcher = function (NoAsAServiceTwoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NoAsAServiceTwoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NoAsAServiceTwoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NoAsAServiceTwoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NoAsAServiceTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NoAsAServiceTwoResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceTwoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NoAsAServiceTwoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NoAsAServiceTwoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NoAsAServiceTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NoAsAServiceTwoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NoAsAServiceTwoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NoAsAServiceTwoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NoAsAServiceTwoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NoAsAServiceTwoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NoAsAServiceTwoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NoAsAServiceTwoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NoAsAServiceTwoResult(['ok' => false])]);
        $this->expectException(NoAsAServiceTwoError::class);
        NoAsAServiceTwoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NoAsAServiceTwoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NoAsAServiceTwoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NoAsAServiceTwoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NoAsAServiceTwoBaseFeature();
        $b = new NoAsAServiceTwoBaseFeature();
        NoAsAServiceTwoFeatureAdd::call($ctx, $a);
        NoAsAServiceTwoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NoAsAServiceTwoBaseFeature
    {
        $f = new NoAsAServiceTwoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NoAsAServiceTwoFeatureAdd::call($ctx, self::named_feature('a'));
        NoAsAServiceTwoFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        NoAsAServiceTwoFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        NoAsAServiceTwoFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        NoAsAServiceTwoFeatureAdd::call($ctx, $replace);
        ...
        NoAsAServiceTwoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NoAsAServiceTwoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NoAsAServiceTwoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NoAsAServiceTwoPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        NoAsAServiceTwoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NoAsAServiceTwoResponse(['headers' => null]),
            'result' => new NoAsAServiceTwoResult([]),
        ]);
        NoAsAServiceTwoResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        NoAsAServiceTwoResultBody::call($ctx);
