...
// NoAsAServiceTwo SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NoAsAServiceTwoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NoAsAServiceTwoOmni::structfix($now, Struct::undef()))
                        !== json_encode(NoAsAServiceTwoOmni::structfix($val, Struct::undef()))) {
