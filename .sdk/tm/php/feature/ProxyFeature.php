...
// NoAsAServiceTwo SDK proxy feature
...
class NoAsAServiceTwoProxyFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    public function init(NoAsAServiceTwoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NoAsAServiceTwoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
