...
// NoAsAServiceTwo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NoAsAServiceTwoTestFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    public function init(NoAsAServiceTwoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NoAsAServiceTwoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = NoAsAServiceTwoParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NoAsAServiceTwoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NoAsAServiceTwoContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = NoAsAServiceTwoParam::call($ctx, $k);
