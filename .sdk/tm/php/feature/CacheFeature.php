...
// NoAsAServiceTwo SDK cache feature
...
class NoAsAServiceTwoCacheFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _through(NoAsAServiceTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
