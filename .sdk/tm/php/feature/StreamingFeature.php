...
// NoAsAServiceTwo SDK streaming feature
...
class NoAsAServiceTwoStreamingFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _iterate(NoAsAServiceTwoResult $result): \Generator
    {
    ...
    private function _streamable(NoAsAServiceTwoContext $ctx): bool
    {
