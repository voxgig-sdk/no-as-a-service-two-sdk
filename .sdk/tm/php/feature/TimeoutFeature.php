...
// NoAsAServiceTwo SDK timeout feature
...
class NoAsAServiceTwoTimeoutFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _with_timeout(NoAsAServiceTwoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NoAsAServiceTwoContext $_ctx, float $ms): void
    {
        $client = $this->client;
