...
// NoAsAServiceTwo SDK rbac feature
...
class NoAsAServiceTwoRbacFeature extends NoAsAServiceTwoBaseFeature
{
    ...
    private function _required(NoAsAServiceTwoContext $ctx): ?string
    {
    ...
    private function _reject(NoAsAServiceTwoContext $ctx, string $required): void
    {
    ...
    private function _track(NoAsAServiceTwoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
