...
// NoAsAServiceTwo SDK utility: fetcher

class NoAsAServiceTwoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NoAsAServiceTwoSDK/1.0)';
    ...
    public static function call(NoAsAServiceTwoContext $ctx, string $fullurl, array $fetchdef): array
    {
