...
class NoAsAServiceTwoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NoAsAServiceTwoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NoAsAServiceTwoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NoAsAServiceTwoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
